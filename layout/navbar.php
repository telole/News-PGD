...
<nav class="bg-gradient-to-b from-gray-800 to-gray-900 text-gray-200">
    <div class="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-6">
            ...
            <a href="createaccount.php" class="hover:text-gray-400">Join Us</a>n 
            <a href="aboutus.php" class="hover:text-gray-400">About Us</a>
        </div>
        <button class="btn btn-warning bg-yellow-500 text-black py-2 px-4 rounded-full" onclick="window.location.href='Login.php'; return false;">Login</button>
